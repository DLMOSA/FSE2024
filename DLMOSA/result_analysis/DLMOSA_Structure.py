...
if __name__ == '__main__':
    ...
    #
        ...
        if ans / total_edge >= (1-0.00001):
            single_branch_model_num += 1
    multi_branch_model_num = K - single_branch_model_num
    multi_rate = multi_branch_model_num / K
    print("single_branch_model_num:" + str(single_branch_model_num))
    print("multi_branch_model_num:"+str(multi_branch_model_num))
    print("multi_rate:"+str(multi_rate))
    unique_model_num = len(numpy.unique(model_structrues))
    print("unique_model_num:"+str(unique_model_num))
#             total += 1
#             if ans == last_layer + 1:
#                 all_count += 1
